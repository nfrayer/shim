...
#define nico 42
#pragma message(TOSTRING(nico))
#pragma message(TOSTRING(OPENSSL_API_LEVEL))
#ifndef OPENSSL_VERSION_MAJOR
#pragma message("OPENSSL_VERSION_MAJOR not defined")
#else
#pragma message("OPENSSL_VERSION_MAJOR IS defined")
#endif
#pragma message(TOSTRING(OPENSSL_VERSION_MAJOR))
#pragma message(TOSTRING(OPENSSL_VERSION_MINOR))
# endif
